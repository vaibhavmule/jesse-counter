...
/**
 * @title JesseCounter
 * @dev A counter contract that tracks increments and rewards users with JESSE tokens
 * @notice Users can increment the counter once every 6 hours and receive JESSE token rewards
 */
contract JesseCounter is Ownable {
