 ...
 * 
 * Contract Features:
 * - 6 hour cooldown between increments
 * - Rewards 1 JESSE token per increment
 * - Daily share reward: 1 JESSE token per day for sharing
